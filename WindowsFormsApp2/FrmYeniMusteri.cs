...
namespace WindowsFormsApp2
{
    public partial class FrmYeniMusteri : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection("Data Source=DESKTOP-8MKN2RO;Initial Catalog=ZEZEOtel;Integrated Security=True");
        ...
        {
            MessageBox.Show("Sarı Renkli Butonlar Boş Odaları Gösterir");
        }
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("insert into MusteriEkle (Adi,Soyadi,Cinsiyet,Telefon,Mail,TC,OdaNo,Ucret,GirisTarihi,CikisTarihi) Values('"+ TxtAdi.Text+"','"+ TxtSoyadi.Text+"','"+ comboBox1.Text+"','"+MskTxtTelefon.Text+"','"+ TxtTcNo.Text+"','"+TxtMail.Text+"','"+TxtOdaNumarasi.Text+"','"+TxtUcret.Text+"','"+DtpGirisTarihi.Value.ToString("yyyy-MM-dd")+"','"+DtpCikisTarihi.Value.ToString("yyyy-MM-dd")+"')",baglanti);
            komut.ExecuteNonQuery();
            baglanti.Close();
...
//Data Source = DESKTOP - 8MKN2RO; Initial Catalog = ZEZEOtel; Integrated Security = True
//Data Source=DESKTOP-8MKN2RO;Initial Catalog=ZEZEOtel;Integrated Security=True